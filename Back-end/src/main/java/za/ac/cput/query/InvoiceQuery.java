...
public class InvoiceQuery {
    public static final String INSERT_INVOICE_QUERY = "INSERT INTO Invoices (customer_id, amount, due_date, paid) VALUES (:customerId, :amount, :dueDate, :paid)";
    public static final String SELECT_INVOICE_BY_ID_QUERY = "SELECT * FROM Invoices WHERE id = :id";
    public static final String UPDATE_INVOICE_QUERY = "UPDATE Invoices SET customer_id = :customerId, amount = :amount, due_date = :dueDate, paid = :paid WHERE id = :id";
