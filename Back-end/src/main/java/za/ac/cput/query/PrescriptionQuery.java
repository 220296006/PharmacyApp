...
public class PrescriptionQuery {
    ...
    public static final String UPDATE_CUSTOMER_LINKED_TO_PRESCRIPTION_QUERY =  "UPDATE Prescription SET customer_id = :customerId WHERE id = :id";
   public static final String FETCH_ALL_PRESCRIPTIONS_QUERY =  "SELECT * FROM Prescriptions";
}
