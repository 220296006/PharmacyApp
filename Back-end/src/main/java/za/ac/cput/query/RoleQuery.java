...
public class RoleQuery {
     ...
     public static final String INSERT_ROLE_QUERY = """
             INSERT INTO Roles (name, permission) VALUES
                 ...
                 ('ROLE_ADMIN', 'READ:USER,READ:CUSTOMER,CREATE:USER,DELETE:USER,DELETE:CUSTOMER,
                 UPDATE:USER,UPDATE:CUSTOMER'),
                 ('ROLE_SYSADMIN', 'READ:USER,READ:CUSTOMER,CREATE:USER,CREATE:CUSTOMER,UPDATE:USER,UPDATE:CUSTOMER,
