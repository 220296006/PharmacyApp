...
public class CustomerQuery {
 public static final String INSERT_CUSTOMER_QUERY = "INSERT INTO Customers (address, first_name, city, state, zip_code, user_id) VALUES (:address, :first_name, :city, :state, :zipCode, :user_id)";
...
public static final String UPDATE_CUSTOMER_QUERY = "UPDATE Customers SET address = :address, first_name = :first_name, city = :city, state = :state, zip_code = :zipCode WHERE id = :id";
