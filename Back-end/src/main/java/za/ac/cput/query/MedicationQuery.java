...
public class MedicationQuery {
    ...
    public static final String UPDATE_PRESCRIPTION_LINKED_TO_MEDICATION_QUERY = "UPDATE Medications SET prescription_id = :prescription_id WHERE id = :medicationId";
    public static final String FETCH_ALL_MEDICATIONS_QUERY = "SELECT * FROM Medications";
